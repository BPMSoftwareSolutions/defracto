...
`generated/tools/validate-lineage.js` exists only as a resolver-materialized generated doorway and owns no validation truth.
...
- `archive/tools/validate-lineage/README.md`
...
- `conveyor/runs/2026/06/21/reports/slice-004j-story-graph-operational-doorway-materialization.latest.md`

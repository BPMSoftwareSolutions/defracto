...
Define `generated/tools/validate-lineage.js` as a future executable projection of the accepted Slice 002 contract before any code exists.

## Executable Identity

- `toolKey`: `defracto.tools.validate_lineage`
- `executablePath`: `generated/tools/validate-lineage.js`
- `projectionOf`: `generated/tools/contracts/validate-lineage.contract.md`

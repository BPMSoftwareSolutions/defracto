...
- The resolver materialized the governed ASCII sketch at the reconciled canonical target path: `projections/target-sketches/founding-lineage-flow.ascii`.
- The resolver emitted the reconciled render receipt at `evidence/target-sketches/founding-lineage-flow.render.receipt.v1.json`.
- The receipt records the canonical target path and the governed materialization hash.
- The older doorway file at `projections/founding-conversation/ui/founding-ui-sketch.ascii` was left untouched.

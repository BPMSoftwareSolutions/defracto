...
- `projections/founding-conversation/ui/founding-ui-sketch.ascii` now exists only as a resolver-materialized generated doorway.
- `evidence/founding-conversation/founding-ui-sketch.render.receipt.v1.json` records the source SEJ, projection manifest, layout contract, target path, and content hash.

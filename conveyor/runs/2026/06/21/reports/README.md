...
This folder holds human-readable proof surfaces produced by the conveyor run envelope.

The required minimum report section contracts are defined by `docs/decisions/D006-minimum-artifact-shapes.md`.

Seed reports in this envelope:

...
- The projection manifest, layout contract, render SEJ, materialization SEJ, and equivalence SEJ now agree on the canonical target artifact path: `examples/target-sketches/projections/founding-lineage-flow.ascii`.
- The receipt target path was updated to the canonical evidence path: `examples/target-sketches/evidence/founding-lineage-flow.render.receipt.v1.json`.

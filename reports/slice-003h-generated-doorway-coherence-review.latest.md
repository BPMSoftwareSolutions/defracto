...
- `tools/README.md` now distinguishes hand-authored tools from the resolver-materialized doorway.
- `reports/body-disposition.seed.md` now records that the doorway is materialized, not authored.
